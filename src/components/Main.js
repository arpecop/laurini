          ...
          {!this.props.lang ? (
            <>
              ...
              <p>
                ...
                сърце могат освен да те разкрасят и одухотворят.Извън
                естетичната си насоченост силата на светлинната терапия може да
                оздрави и подобри процесите на възстановяване на организма Ви в
                дадената област, след хирургическа намеса, след спортна травма,
                след стрес и преумора.Най вече ние сме там ,където искате да
                бъдем - до вас през целия процес на разкрасяване и
                възстановяване на вашите кожа, нокти и коса.
              </p>
              <p>
        ...
        >
          {!this.props.lang ? (
            <>
              ...
              <ul>
                <li>
                  Моята професионална работа започна през далечната 2016г когато
                  започнах своето обучение като козметик с ниво 1 и 2 в любимият
                  ми град Пловдив.Продължих да се развивам и градя всеки ден,
                  участия в обучения и семинари, козметични конференции, както и
                  лична практика в обучаващи се от мен козметици и студенти по
                  медицинска козметика.Всичко това постигнах с много страст,
                  желание и устрем към новостите в козметиката на бъдещето,
                  която всеки ден се развива, сложната апаратура с която работя
                  и не на последно място психологическата, физическа надпревара
                  с времето с която се боря за да осигурявам на всички мои
                  клиенти душевно удоволствие от всяка процедура за да изглеждат
                  подмладени.Приключих своето обучение за ниво 3 по козметика
                  през 2020г в гр. София,{' '}
                </li>
                <li>
